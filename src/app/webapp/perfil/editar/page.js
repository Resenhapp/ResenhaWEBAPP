            ...
            <div className='flex flex-col w-screen h-screen'>
                ...
                <div className="flex flex-col items-center justify-center h-screen px-4">
                    <section className="flex flex-col gap-4 h-full items-center w-full max-w-md p-4">
                        <Modal show={isModalOpen} close={() => setModalOpen(false)}>
                        ...
                        <div className='w-full flex flex-col items-center'>
                            <button className='flex flex-row items-center gap-2 w-fit bg-purpleT1 py-2 px-4 rounded-full ring-2 ring-inset ring-purpleT3'>
                        ...
                        <div className='w-full'>
                            <button className='w-full bg-purpleT1 flex flex-col ring-2 ring-inset ring-purpleT3 px-2 py-2 rounded-2xl'>
                        ...
                        <div className='w-full'>
                            <div className='w-full bg-purpleT1 gap-4 flex flex-col ring-2 ring-inset ring-purpleT3 px-2 py-2 rounded-2xl'>
                                <div className='flex flex-row justify-between w-full'>
