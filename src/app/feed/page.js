          ...
          navigator.geolocation.getCurrentPosition(
            async (position) => {
              try {
                ...
                setInputValue(address);
                setUserLocation(address); // Atualiza o estado userLocation com a localização atual do usuário
  ...
  value={inputValue || userCurrentLocation} // Usando userCurrentLocation como valor padrão
  onChange={(e) => setInputValue(e.target.value)}
  setSelected={handleAddressSelect}
  defaultValue={userCurrentLocation} // Definindo o valor padrão como userCurrentLocation
/>
