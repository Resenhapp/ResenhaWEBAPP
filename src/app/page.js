    ...
    <main className="">
      <div className=' h-screen w-screen'>
        ...
        <section className='relative'>
          ...
          <footer className='relative bottom-0 mb-12 flex flex-col h-fit text-center text-sm bg-purpleT2'>
  <p> Resenha.app® {new Date().getFullYear()} - Todos os direitos reservados. </p>
