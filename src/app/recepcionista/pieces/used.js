...
export default function Used({ returnToHome }) {
    ...
    return (
        <div className="flex flex-col justify-center h-[70vh] mt-12 content-center items-center z-[100]">
            <div className="flex flex-col justify-center gap-4 items-center content-center">
                ...
                <p className='text-3xl font-bold'>Código já utilizado</p>
                <p className="text-center">Esta pessoa <b>não pode passar! </b>O código já foi validado. Instrua a pessoa das regras e a pergunte se ela possui outro código, caso não, siga a política do hospedeiro. </p>
            </div>
