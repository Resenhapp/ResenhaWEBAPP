...
export default function TypeCode({useCamera}) {
    return (
        <div className="flex flex-col justify-center mt-12 content-center items-center z-[100]">
            ...
            <div className='py-3 content-center items-center justify-around flex flex-row px-2 rounded-xl mb-8 bg-whiteT1 w-2/3'><Vector vectorname={'code01'} /><input className='text-purpleT0 text-3xl w-2/3 bg-transparent' maxLength={4} inputMode='tel'></input></div>
            ...
            <button className="bg-whiteT1 px-5 py-5 rounded-full justify-between w-[60vw] mb-16 max-w-[640px] text-purpleT0 text-xl flex flex-row items-center gap-2"><p className=" w-full">Liberar</p><Vector vectorname={'check03'}/></button>
