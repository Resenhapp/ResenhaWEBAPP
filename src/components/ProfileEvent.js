...
const ProfileEvent = ({ partyName, partyDate, partyHour, partyGuests, eventCode, imageUrl }) => {
    ...
    return (
        <div className='bg-purpleT1 h-fit w-full rounded-2xl p-2 flex flex-row ring-1 ring-inset ring-purpleT3' onClick={() => handleClick(eventCode)}>
