...
const OutlinedButton = ({ label, icon }) => {
    ...
    if (icon === 'arrow') {
        iconSvg = (
            <svg width="19" height="19" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" clip-rule="evenodd" d="M9.5 1C4.80558 1 1 4.80558 1 9.5C1 14.1944 4.80558 18 9.5 18C14.1944 18 18 14.1944 18 9.5C18 4.80558 14.1944 1 9.5 1ZM0 9.5C0 4.25329 4.25329 0 9.5 0C14.7467 0 19 4.25329 19 9.5C19 14.7467 14.7467 19 9.5 19C4.25329 19 0 14.7467 0 9.5Z" fill="white" />
    ...
    return (
        <button className="bg-transparent text-whiteT1 h-8 font-regular rounded-full flex justify-between ring-2 ring-inset ring-whiteT1 items-center">
