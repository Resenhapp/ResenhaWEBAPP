...
const MyParty = ({ partyName, partyDate, partyHour, shareParty, viewParty, viewChat, partyCode, imageUrl, viewReceipt, partyPaid }) => {
        ...
        <div className='bg-purpleT1 h-fit w-full rounded-2xl p-2 flex flex-row ring-1 ring-inset ring-purpleT3'>
            ...
            <div className='flex flex-col w-full'>
                ...
                <div className='w-full h-full flex flex-row justify-start gap-2 items-end content-end'>
                    <button onClick={viewChat} className='bg-purpleT2 flex ring-purpleT3 ring-inset rounded-full ring-1 w-8 h-8 align-center justify-center items-center'>
