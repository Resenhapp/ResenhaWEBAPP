...
const PartyPortrait = ({ ViewOnClick, EditOnClick, CopyOnClick, TrashOnClick, canBeDeleted = true, partyName, partyImage, partyDate, partyHour, partyGuests, partyMaxGuests }) => {
