      ...
      >
        {showPassword ? (
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path fill-rule="evenodd" clip-rule="evenodd" d="M11.0955 17.9607C11.3879 17.9865 11.6893 18 12 18C16.9091 18 21 12 21 12C21 12 20.3304 11.0179 19.2079 9.84836L11.0955 17.9607Z" fill="#8500FF" />
            <path fill-rule="evenodd" clip-rule="evenodd" d="M14.5051 6.49485C13.7076 6.18695 12.8665 6 12 6C5.45455 6 3 12 3 12C3 12 3.75006 13.8335 5.52661 15.4734L9 12C9 10.3431 10.3431 9 12 9L14.5051 6.49485Z" fill="#8500FF" />
            <rect x="5.1" y="18.435" width="19" height="2" transform="rotate(-45 5.1 18.435)" fill="#8500FF" />
          </svg>
        ) : (
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path fill-rule="evenodd" clip-rule="evenodd" d="M11.0955 17.9607C11.3879 17.9865 11.6893 18 12 18C16.9091 18 21 12 21 12C21 12 20.3304 11.0179 19.2079 9.84836L11.0955 17.9607Z" fill="#8500FF" />
            <path fill-rule="evenodd" clip-rule="evenodd" d="M12 6C5.45455 6 3 12 3 12C3 12 5.45455 18 12 18C16.9091 18 21 12 21 12C21 12 16.9091 6 12 6ZM9 12C9 13.6569 10.3431 15 12 15C13.6569 15 15 13.6569 15 12C15 10.3431 13.6569 9 12 9C10.3431 9 9 10.3431 9 12Z" fill="#8500FF" />
          </svg>
        )}
      </button>
    </div>
