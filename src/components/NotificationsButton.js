...
const NotificationsButton = ({ dotVisible, toggleNotifications }) => {
    return (
        <div className='flex flex-rom align-bottom items-end justify-end'>
            <button onClick={toggleNotifications} className="bg-purpleT2 text-whiteT1 shadow-2xl h-14 w-14 rounded-full flex justify-center ring-1 ring-purpleT3 align-center items-center">
